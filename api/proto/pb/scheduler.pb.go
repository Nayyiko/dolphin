...
type Task struct {
	...
	DependOn      []string               `protobuf:"bytes,13,rep,name=depend_on,json=dependOn,proto3" json:"depend_on,omitempty"`    // 上游任务 ID 列表（DAG 依赖）
	DepPolicy     string                 `protobuf:"bytes,14,opt,name=dep_policy,json=depPolicy,proto3" json:"dep_policy,omitempty"` // all_success / all_completed
...
func (x *Task) GetDependOn() []string {
	if x != nil {
		return x.DependOn
	}
	return nil
...
func (x *Task) GetDepPolicy() string {
	if x != nil {
		return x.DepPolicy
	}
	return ""
...
type CreateTaskRequest struct {
	...
	DependOn      []string               `protobuf:"bytes,8,rep,name=depend_on,json=dependOn,proto3" json:"depend_on,omitempty"`
	DepPolicy     string                 `protobuf:"bytes,9,opt,name=dep_policy,json=depPolicy,proto3" json:"dep_policy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateTaskRequest) GetDependOn() []string {
	if x != nil {
		return x.DependOn
	}
	return nil
...
func (x *CreateTaskRequest) GetDepPolicy() string {
	if x != nil {
		return x.DepPolicy
	}
	return ""
...
type UpdateTaskRequest struct {
	...
	DependOn      []string               `protobuf:"bytes,9,rep,name=depend_on,json=dependOn,proto3" json:"depend_on,omitempty"`
	DepPolicy     string                 `protobuf:"bytes,10,opt,name=dep_policy,json=depPolicy,proto3" json:"dep_policy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateTaskRequest) GetDependOn() []string {
	if x != nil {
		return x.DependOn
	}
	return nil
...
func (x *UpdateTaskRequest) GetDepPolicy() string {
	if x != nil {
		return x.DepPolicy
	}
	return ""
...
const file_api_proto_scheduler_proto_rawDesc = "" +
	"\n" +
	"\x19api/proto/scheduler.proto\x12\adolphin\"\x89\x03\n" +
	"\x04Task\x12\x0e\n" +
	...
	"\n" +
	"updated_at\x18\f \x01(\x03R\tupdatedAt\x12\x1b\n" +
	"\tdepend_on\x18\r \x03(\tR\bdependOn\x12\x1d\n" +
	"\n" +
	"dep_policy\x18\x0e \x01(\tR\tdepPolicy\"\a\n" +
	"\x05Empty\"\x90\x02\n" +
	...
	"maxRetries\x12\x1b\n" +
	"\tdepend_on\x18\b \x03(\tR\bdependOn\x12\x1d\n" +
	"\n" +
	"dep_policy\x18\t \x01(\tR\tdepPolicy\" \n" +
	...
	"maxRetries\x12\x1b\n" +
	"\tdepend_on\x18\t \x03(\tR\bdependOn\x12\x1d\n" +
	"\n" +
	"dep_policy\x18\n" +
	" \x01(\tR\tdepPolicy\"#\n" +
