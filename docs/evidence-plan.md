...
| 4 | 精确限流 | ✅ VM 复现（Redis+慢管道） | ΔR 与理论误差 <0.1%（14147→12448 / 14210→12710）；待 Windows 实机跑 `hack/ratelimit_test.ps1` 确认 |
| 4 | 多实例共享 | ❌ 缺 | 起 2 gateway，跑 `hack/ratelimit_shared_test.ps1` |
